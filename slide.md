...
| 研究者 | 年 | 貢献 |
|:------:|:--:|:-----|
| Hopkins | 1980 | 難破船を交易指標として初めて体系的に使用 |
| Parker | 1992 | 地中海難破船データベースの構築 |

## Hopkins (1980) の議論
- 『Taxes and Trade in the Roman Empire』(*Journal of Roman Studies*)
- 課税が属州間貿易を刺激 → 難破船数の増加として観測可能
- 難破船数 ≈ 海上交易量の代理指標という仮定を確立
